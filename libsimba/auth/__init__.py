...
from libsimba.settings import CLIENT_ID, CLIENT_SECRET, SCOPE, AUTH_FLOW

if (CLIENT_ID is None or SCOPE is None or TENANT_ID is None or (AUTH_FLOW == 'client_credentials' and CLIENT_SECRET is None)):
  raise Exception(
"""
