...
class Testcontract_vbb1:
    ...
    class Person(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addr: "Testcontract_vbb1.Addr" = None):
            self.name = name
            self.age = age
            self.addr = addr
    ...
    class AddressPerson(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addrs: List["Testcontract_vbb1.Addr"] = None):
            self.name = name
            self.age = age
            self.addrs = addrs
    ...
    async def structTest1(
        self,
        people: List["Testcontract_vbb1.Person"] = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest2(
        self,
        person: "Testcontract_vbb1.Person" = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest3(
        self,
        person: "Testcontract_vbb1.AddressPerson" = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest4(
        self,
        persons: List["Testcontract_vbb1.AddressPerson"] = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
