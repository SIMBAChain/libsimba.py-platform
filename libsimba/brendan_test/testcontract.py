...
class TestContract:
    def __init__(self):
        ...
        self.contract_name = "testcontract_vbb1"
    ...
    class AddressPerson(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addrs: List["TestContract.Addr"] = None):
            self.name = name
            self.age = age
            self.addrs = addrs
    ...
    async def nowT(
        ...
        """
        If qry_mthd == True, then invocations of nowT will be queried. Otherwise nowT will be invoked with inputs.
        """
        inputs = {
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("nowT", inputs, query_args = query_args)
            return res
    ...
    def nowT_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("nowT", inputs, query_args = query_args)
            return res
    ...
    async def anArr(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of anArr will be queried. Otherwise anArr will be invoked with inputs.
        """
        inputs = {
            "first": first,
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("anArr", inputs, query_args = query_args)
            return res
    ...
    def anArr_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("anArr", inputs, query_args = query_args)
            return res
    ...
    async def getNum(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of getNum will be queried. Otherwise getNum will be invoked with inputs.
        """
        inputs = {
        }
        convert_classes(inputs)
    ...
    async def setNum(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of setNum will be queried. Otherwise setNum will be invoked with inputs.
        """
        inputs = {
            "_ourNum": _ourNum,
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("setNum", inputs, query_args = query_args)
            return res
    ...
    def setNum_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("setNum", inputs, query_args = query_args)
            return res
    ...
    async def twoArrs(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of twoArrs will be queried. Otherwise twoArrs will be invoked with inputs.
        """
        inputs = {
            "first": first,
            "second": second,
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("twoArrs", inputs, query_args = query_args)
            return res
    ...
    def twoArrs_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("twoArrs", inputs, query_args = query_args)
            return res
    ...
    async def getString(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of getString will be queried. Otherwise getString will be invoked with inputs.
        """
        inputs = {
        }
        convert_classes(inputs)
    ...
    async def setString(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of setString will be queried. Otherwise setString will be invoked with inputs.
        """
        inputs = {
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("setString", inputs, query_args = query_args)
            return res
    ...
    def setString_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("setString", inputs, query_args = query_args)
            return res
    ...
    async def addressArr(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of addressArr will be queried. Otherwise addressArr will be invoked with inputs.
        """
        inputs = {
            "first": first,
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("addressArr", inputs, query_args = query_args)
            return res
    ...
    def addressArr_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("addressArr", inputs, query_args = query_args)
            return res
    ...
    async def nestedArr0(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of nestedArr0 will be queried. Otherwise nestedArr0 will be invoked with inputs.
        """
        inputs = {
            "first": first,
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("nestedArr0", inputs, query_args = query_args)
            return res
    ...
    def nestedArr0_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("nestedArr0", inputs, query_args = query_args)
            return res
    ...
    async def nestedArr1(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of nestedArr1 will be queried. Otherwise nestedArr1 will be invoked with inputs.
        """
        inputs = {
            "first": first,
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("nestedArr1", inputs, query_args = query_args)
            return res
    ...
    def nestedArr1_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("nestedArr1", inputs, query_args = query_args)
            return res
    ...
    async def nestedArr2(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of nestedArr2 will be queried. Otherwise nestedArr2 will be invoked with inputs.
        """
        inputs = {
            "first": first,
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("nestedArr2", inputs, query_args = query_args)
            return res
    ...
    def nestedArr2_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("nestedArr2", inputs, query_args = query_args)
            return res
    ...
    async def nestedArr3(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of nestedArr3 will be queried. Otherwise nestedArr3 will be invoked with inputs.
        """
        inputs = {
            "first": first,
        }
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("nestedArr3", inputs, query_args = query_args)
            return res
    ...
    def nestedArr3_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("nestedArr3", inputs, query_args = query_args)
            return res
    ...
    async def nestedArr4(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of nestedArr4 will be queried. Otherwise nestedArr4 will be invoked with inputs.
    ...
    async def structTest1(
        self,
        people: List["TestContract.Person"] = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        qry_mthd: Optional[bool] = False,
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of structTest1 will be queried. Otherwise structTest1 will be invoked with inputs.
        """
        inputs = {
            "people": people,
            "test_bool": test_bool,
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("structTest1", inputs, query_args = query_args)
            return res
    ...
    def structTest1_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("structTest1", inputs, query_args = query_args)
            return res
    
    async def structTest2(
        self,
        person: "TestContract.Person" = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        qry_mthd: Optional[bool] = False,
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of structTest2 will be queried. Otherwise structTest2 will be invoked with inputs.
        """
        inputs = {
            "person": person,
            "test_bool": test_bool,
        ...
        if qry_mthd:
            ...
            res = await self.simba_contract.call_method("structTest2", inputs, query_args = query_args)
            return res
    ...
    def structTest2_sync(
        ...
        if qry_mthd:
            ...
            res = self.simba_contract_sync.call_method("structTest2", inputs, query_args = query_args)
            return res
    
    async def structTest3(
        self,
        person: "TestContract.AddressPerson" = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        qry_mthd: Optional[bool] = False,
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of structTest3 will be queried. Otherwise structTest3 will be invoked with inputs.
    ...
    async def structTest4(
        self,
        persons: List["TestContract.AddressPerson"] = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        qry_mthd: Optional[bool] = False,
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of structTest4 will be queried. Otherwise structTest4 will be invoked with inputs.
    ...
    async def structTest5(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of structTest5 will be queried. Otherwise structTest5 will be invoked with inputs.
    ...
    async def clientContainer(
        ...
        search_filter: SearchFilter = None):
        """
        If qry_mthd == True, then invocations of clientContainer will be queried. Otherwise clientContainer will be invoked with inputs.
