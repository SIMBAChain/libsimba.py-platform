...
class Complexcontract_v1:
    def __init__(self):
        self.app_name = "BrendanTestApp"
        self.base_api_url = BASE_API_URL
        self.contract_name = "complexcontract_v1"
    ...
    class Person(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addr: "Complexcontract_v1.Addr" = None):
            self.name = name
            self.age = age
            self.addr = addr
    ...
    class AddressPerson(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addrs: List["Complexcontract_v1.Addr"] = None):
            self.name = name
            self.age = age
            self.addrs = addrs
    ...
    async def structTest1(
        self,
        people: List["Complexcontract_v1.Person"] = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest2(
        self,
        person: "Complexcontract_v1.Person" = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest3(
        self,
        person: "Complexcontract_v1.AddressPerson" = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest4(
        self,
        persons: List["Complexcontract_v1.AddressPerson"] = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
