...
class Complexcontract_v3:
    ...
    class Person(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addr: "Complexcontract_v3.Addr" = None):
            self.name = name
            self.age = age
            self.addr = addr
    ...
    class AddressPerson(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addrs: List["Complexcontract_v3.Addr"] = None):
            self.name = name
            self.age = age
            self.addrs = addrs
    ...
    async def structTest1(
        self,
        people: List["Complexcontract_v3.Person"] = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest2(
        self,
        person: "Complexcontract_v3.Person" = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest3(
        self,
        person: "Complexcontract_v3.AddressPerson" = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest4(
        self,
        persons: List["Complexcontract_v3.AddressPerson"] = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
