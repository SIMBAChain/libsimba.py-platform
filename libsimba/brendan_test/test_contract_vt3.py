...
class Test_contract_vt3:
    ...
    class Person(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addr: "Test_contract_vt3.Addr" = None):
            self.name = name
            self.age = age
            self.addr = addr
    ...
    class AddressPerson(ClassToDictConverter):
        def __init__(
            ...
            name: str = "None",
            age: int = None,
            addrs: List["Test_contract_vt3.Addr"] = None):
            self.name = name
            self.age = age
            self.addrs = addrs
    ...
    async def structTest1(
        self,
        people: List["Test_contract_vt3.Person"] = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest2(
        self,
        person: "Test_contract_vt3.Person" = None,
        test_bool: bool = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest3(
        self,
        person: "Test_contract_vt3.AddressPerson" = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    async def structTest4(
        self,
        persons: List["Test_contract_vt3.AddressPerson"] = None,
        files: List[Tuple] = None,
        query_args: Optional[dict] = None,
        do_query: Optional[bool] = False,
        search_filter: SearchFilter = None):
    ...
    def structTest5_sync(
        ...
        if do_query:
            ...
            files = open_files(files)
            # file_type = 'file'
            # file_name = files[0][1][0]
            # real_file = files[0][1][1]
            # files = {
            #     file_type: (
            #         file_name,
            #         real_file
