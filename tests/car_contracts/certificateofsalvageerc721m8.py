...
class CertificateOfSalvageERC721M8(Context,AccessControlEnumerable,ERC721Enumerable,ERC721Burnable,ERC721Pausable,IAccessControlEnumerable,AccessControl,IAccessControl,ERC165,IERC165,ERC721,IERC721Enumerable,IERC721,IERC721Metadata,Pausable):
    def __init__(self):
        self.app_name = "titles"
        self.base_api_url = "https://api.sep.dev.simbachain.com/"
        self.contract_name = "CertificateOfSalvageERC721M8"
    ...
    class UintSet(ClassToDictConverter):
        def __init__(self, _inner: "CertificateOfSalvageERC721M8.Set" = None):
            self._inner=_inner
